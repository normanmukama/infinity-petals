...
<head>
    ...
    <title>Infinity petals ug</title>
 ...
 <!-- <div class="navbar navbar-inverse navbar-fixed-top " id="menu">
   ...
   <div class="container">
               ...
               <div class="col-lg-12  col-md-12 col-sm-12">
                ...
                <div class="flexslider set-flexi" id="main-section" >
                    <ul class="slides move-me">
                        <!-- Slider 01 -->
                        <li>
                              <h3>Let Flowers Speak For You</h3>
                        ...
                        <!-- Slider 02 -->
                        <li>
                            <h3 class="text-success">LET FLOWERS SPEAK FOR YOU</h3>
                        ...
                        <!-- Slider 03 -->
                        <li>
                            <h3 class="text-info">LET FLOWERS SPEAK FOR YOU</h3>
    ...
    <div  class="tag-line" >
        ...
        <h2 data-scroll-reveal="enter from the bottom after 0.1s" ><i class="fa fa-circle-o-notch"></i>WELCOME TO THE INFINITY PetalsWeb <i class="fa fa-circle-o-notch"></i> </h2>
                   </div>
               </div>
             </div>
    ...
    <div id="course-sec" class="container set-pad">
      <div class="row text-center">
          <div class="col-lg-8 col-lg-offset-2 col-md-8 col-sm-8 col-md-offset-2 col-sm-offset-2">
              ...
              If you have any questions, please feel free to contact us, we shall come back to you shortly.
