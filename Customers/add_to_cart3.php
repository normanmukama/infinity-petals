...
<body>
    <div id="wrapper">
        ...
        <form role="form" method="post" action="save_order2.php">
            <?php
            if(isset($errMSG)){
                ?>
            ...
            <div class="alert alert-default" style="color:white;background-color:#008CBA">
                ...
                <table class="table table-bordered table-responsive">
                    ...
                    <tr>
                        ...
                        <td>
                            <p><img class="img img-thumbnail" src="../Admin/item_images/<?php echo $item_image; ?>" style="height:280px;width:280px;" /></p>
                        </td>
                        <tr>
                    ...
                    <tr>
                        ...
                        <a class="btn btn-danger" href="shop3.php?id=1"> <span class="glyphicon glyphicon-backward"></span> Cancel </a>
                        </td>
                    </tr>
            </table> 
        </form>	
