...
<body>
    ...
    <?php
session_start();
include './customers/db_conection.php';
...
<head>
    ...
    <script type="text/javascript" src="customers/js/jquery-1.10.2.min.js"></script>
...
<body>
    <div id="wrapper">
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
         ...
         <center><h3> <span class="glyphicon glyphicon-shopping-cart"></span> This is our infinity petals stocks, Shop now!</h3></center>
        </div>
...
?>
			...
			<div class="alert alert-default" style="background-color:#033c73;">
                       <p style="color:white;text-align:center;">
                         &copy 2023 Infinity Petals| All Rights Reserved |						</p>
                    </div>
                </div>
            </div>  
        </div>	
